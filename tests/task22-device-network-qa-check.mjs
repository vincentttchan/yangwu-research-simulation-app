...
[
  ...
  'Current decision: home/individual network testing accepted',
  'Normal-flow UI follow-up',
  ...
  'Phone',
  'School Wi-Fi',
  'Home/individual network check',
  'school Wi-Fi is no longer required',
  'Do not treat this item as passed',
  'Supabase Row Verification',
  'Privacy QA',
  'Pending',
